...
/n/home05/kvjmistry/packages/GarfieldCode/Electroluminescence/build/CRAB ${SEED} ${N_EVENTS} ${SEED} 1 ${SLURM_ARRAY_TASK_ID} 2>&1 | tee -a log_nexus_"${SLURM_ARRAY_TASK_ID}".txt
